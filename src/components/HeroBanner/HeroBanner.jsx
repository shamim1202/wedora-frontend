...
const HeroBanner = () => {
  return (
    <div className="relative min-h-screen bg-background-light dark:bg-background-dark pt-16 sm:pt-20">
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-full sm:w-2/3 h-full bg-linear-to-l from-pink-100/50 via-pink-50/20 to-transparent dark:from-pink-900/10 dark:via-pink-900/5 dark:to-transparent"></div>
      </div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 min-h-[calc(100vh-4rem)] sm:min-h-[calc(100vh-5rem)] flex items-center py-8 sm:py-12">
