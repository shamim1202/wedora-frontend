...
const TopService = () => {
  ...
  return (
    <section className="py-16 lg:py-20 bg-gradient-to-br from-pink-50/50 via-background-light to-pink-50/30 dark:from-gray-900 dark:via-background-dark dark:to-gray-900">
